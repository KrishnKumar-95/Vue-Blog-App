...
export const LOGIN_UNSUCCESS: string = "User can't login"
export const LOGOUT_SUCCESS: string = "Logout Successfully"

// Stores
export const AUTH_STORE_ID: string = "AUTH_STORE"
export const BLOG_STORE_ID: string = "BLOG_STORE"